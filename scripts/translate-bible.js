...
const BIBLE_BOOKS = [
  { abbr: "gn", name: "Gênesis", testament: "AT", chapters: 50 }, { abbr: "ex", name: "Êxodo", testament: "AT", chapters: 40 },
  { abbr: "lv", name: "Levítico", testament: "AT", chapters: 27 }, { abbr: "nm", name: "Números", testament: "AT", chapters: 36 },
  { abbr: "dt", name: "Deuteronômio", testament: "AT", chapters: 34 }, { abbr: "js", name: "Josué", testament: "AT", chapters: 24 },
  { abbr: "jz", name: "Juízes", testament: "AT", chapters: 21 }, { abbr: "rt", name: "Rute", testament: "AT", chapters: 4 },
  { abbr: "1sm", name: "1 Samuel", testament: "AT", chapters: 31 }, { abbr: "2sm", name: "2 Samuel", testament: "AT", chapters: 24 },
  { abbr: "1rs", name: "1 Reis", testament: "AT", chapters: 22 }, { abbr: "2rs", name: "2 Reis", testament: "AT", chapters: 25 },
  { abbr: "1cr", name: "1 Crônicas", testament: "AT", chapters: 29 }, { abbr: "2cr", name: "2 Crônicas", testament: "AT", chapters: 36 },
  { abbr: "ed", name: "Esdras", testament: "AT", chapters: 10 }, { abbr: "ne", name: "Neemias", testament: "AT", chapters: 13 },
  { abbr: "et", name: "Ester", testament: "AT", chapters: 10 }, { abbr: "jó", name: "Jó", testament: "AT", chapters: 42 },
  { abbr: "sl", name: "Salmos", testament: "AT", chapters: 150 }, { abbr: "pv", name: "Provérbios", testament: "AT", chapters: 31 },
  { abbr: "ec", name: "Eclesiastes", testament: "AT", chapters: 12 }, { abbr: "ct", name: "Cantares", testament: "AT", chapters: 8 },
  { abbr: "is", name: "Isaías", testament: "AT", chapters: 66 }, { abbr: "jr", name: "Jeremias", testament: "AT", chapters: 52 },
  { abbr: "lm", name: "Lamentações", testament: "AT", chapters: 5 }, { abbr: "ez", name: "Ezequiel", testament: "AT", chapters: 48 },
  { abbr: "dn", name: "Daniel", testament: "AT", chapters: 12 }, { abbr: "os", name: "Oséias", testament: "AT", chapters: 14 },
  { abbr: "jl", name: "Joel", testament: "AT", chapters: 3 }, { abbr: "am", name: "Amós", testament: "AT", chapters: 9 },
  { abbr: "ob", name: "Obadias", testament: "AT", chapters: 1 }, { abbr: "jn", name: "Jonas", testament: "AT", chapters: 4 },
  { abbr: "mq", name: "Miquéias", testament: "AT", chapters: 7 }, { abbr: "na", name: "Naum", testament: "AT", chapters: 3 },
  { abbr: "hc", name: "Habacuque", testament: "AT", chapters: 3 }, { abbr: "sf", name: "Sofonias", testament: "AT", chapters: 3 },
  { abbr: "ag", name: "Ageu", testament: "AT", chapters: 2 }, { abbr: "zc", name: "Zacarias", testament: "AT", chapters: 14 },
  { abbr: "ml", name: "Malaquias", testament: "AT", chapters: 4 }, { abbr: "mt", name: "Mateus", testament: "NT", chapters: 28 },
  { abbr: "mc", name: "Marcos", testament: "NT", chapters: 16 }, { abbr: "lc", name: "Lucas", testament: "NT", chapters: 24 },
  { abbr: "jo", name: "João", testament: "NT", chapters: 21 }, { abbr: "at", name: "Atos", testament: "NT", chapters: 28 },
  { abbr: "rm", name: "Romanos", testament: "NT", chapters: 16 }, { abbr: "1co", name: "1 Coríntios", testament: "NT", chapters: 16 },
  { abbr: "2co", name: "2 Coríntios", testament: "NT", chapters: 13 }, { abbr: "gl", name: "Gálatas", testament: "NT", chapters: 6 },
  { abbr: "ef", name: "Efésios", testament: "NT", chapters: 6 }, { abbr: "fp", name: "Filipenses", testament: "NT", chapters: 4 },
  { abbr: "cl", name: "Colossenses", testament: "NT", chapters: 4 }, { abbr: "1ts", name: "1 Tessalonicenses", testament: "NT", chapters: 5 },
  { abbr: "2ts", name: "2 Tessalonicenses", testament: "NT", chapters: 3 }, { abbr: "1tm", name: "1 Timóteo", testament: "NT", chapters: 6 },
  { abbr: "2tm", name: "2 Timóteo", testament: "NT", chapters: 4 }, { abbr: "tt", name: "Tito", testament: "NT", chapters: 3 },
  { abbr: "fm", name: "Filemom", testament: "NT", chapters: 1 }, { abbr: "hb", name: "Hebreus", testament: "NT", chapters: 13 },
  { abbr: "tg", name: "Tiago", testament: "NT", chapters: 5 }, { abbr: "1pe", name: "1 Pedro", testament: "NT", chapters: 5 },
  { abbr: "2pe", name: "2 Pedro", testament: "NT", chapters: 3 }, { abbr: "1jo", name: "1 João", testament: "NT", chapters: 5 },
  { abbr: "2jo", name: "2 João", testament: "NT", chapters: 1 }, { abbr: "3jo", name: "3 João", testament: "NT", chapters: 1 },
  { abbr: "jd", name: "Judas", testament: "NT", chapters: 1 }, { abbr: "ap", name: "Apocalipse", testament: "NT", chapters: 22 }
];
...
let state = {
  ...
  chaptersCompleted: 0, versesTranslated: 0,
  apiRetries: 0, validationErrors: 0, rateLimitWaitMs: 0,
  startTime: Date.now(),
  avgTimePerChapter: 0, etaMs: 0,
  logs: []
};
...
function validateTranslation(verses, originalCount) {
  ...
  if (verses.length !== originalCount) throw new Error(`Esperava ${originalCount} versículos, mas vieram ${verses.length}`);
  ...
  for (let i = 0; i < verses.length; i++) {
    ...
    if (v.text.includes('(') || v.text.includes(')')) {
      throw new Error(`Texto do versículo ${v.verse} contém parênteses, o que é estritamente proibido nesta tradução. O texto deve fluir puramente.`);
    }
    ...
    for (const term of textMatches) {
      if (!kwTerms.includes(term)) {
        throw new Error(`O termo "{{${term}}}" aparece no versículo ${v.verse} mas não está mapeado em key_words`);
      }
    }
...
async function translateChapter(bookAbbr, chapter, versesObj, testament, bookIndex) {
  ...
  const versesListText = Object.entries(versesObj).map(([v, txt]) => `v.${v}: ${txt}`).join('\n');
  ...
  try {
    ...
    if (fs.existsSync(glossaryPath)) {
      ...
      if (terms) {
        ...
        const relevantTerms = Object.entries(terms).filter(([k, v]) => originalListText.includes(k));
    ...
    for (let c = startCh; c <= endCh; c++) {
      ...
      if (!isForce) {
        ...
        if (existingCount === expectedVerseCount) {
          ...
          logMsg(`Capítulo ${book.name} ${c} está incompleto (${existingCount}/${expectedVerseCount} versículos). Reprocessando para cobrir o buraco...`);
        }
      }
      ...
      while (!success) {
        try {
          ...
          const translated = await translateChapter(book.abbr, c, chapterVersesObj, book.testament, bookIndex);
          ...
          const isTemporaryNetwork = err.message.includes("fetch failed") || err.message.includes("500") || err.message.includes("502") || err.message.includes("503") || err.message.includes("ETIMEDOUT");
          ...
          if (isRateLimit || isTemporaryNetwork) {
            ...
            logMsg(`Erro de Validação (Tentativa ${retries}/${maxRetries}) para ${book.name} ${c}: ${err.message}`, true);
            
            if (retries >= maxRetries) {
              logMsg(`CRÍTICO: ${book.name} ${c} falhou estruturalmente após ${maxRetries} tentativas. PROCESSO INTERROMPIDO.`, true);
