...
console.log(
  ...
  supabaseUrl ? supabaseUrl.split(".")[0] + "..." : "NOT FOUND",
);
console.log(
  "Supabase Key configured (first 10 chars):",
  supabaseKey ? supabaseKey.substring(0, 10) + "..." : "NOT FOUND",
);
...
async function testConnection() {
  ...
  const { data: d2, error: e2 } = await supabase
    .from("uma_tabela_que_nao_existe_123")
    .select("*")
    .limit(1);
