...
> = {
  beginner: {
    ...
    description:
      "Para quem está começando ou quer criar novos hábitos. Você receberá incentivos, explicações simples e desafios acessíveis que crescem com você.",
  ...
  walking: {
    ...
    description:
      "Para quem já possui alguma rotina espiritual. O app vai sugerir planos de leitura mais completos e desafios intermediários para fortalecer o que você já construiu.",
  ...
  deepening: {
    ...
    description:
      "Para quem já estuda com frequência. Você terá acesso facilitado a estudos exegéticos, comparações entre traduções e palavras no original grego e hebraico.",
...
function OptionCard({
  ...
  return (
    <motion.button
      ...
      style={{
        background: pressing ? "oklch(0.65 0.18 270 / 0.2)" : "oklch(1 0 0 / 0.07)",
    ...
    >
      ...
      <span className="ml-auto text-white/20 group-hover:text-white/50 transition-colors relative z-10 text-lg">
        ›
      </span>
    </motion.button>
  );
...
function QuizPage() {
  ...
  const progressPct =
    typeof step === "number" ? ((step + 1) / QUESTIONS.length) * 100 : step === "result" ? 100 : 0;
  ...
  return (
    <div className="relative min-h-screen w-screen overflow-hidden bg-[#0d0b1e] text-white">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 90% 90% at 50% 50%, transparent 20%, rgba(8,5,24,.85) 100%)",
        }}
      />
        ...
        {step !== "intro" && (
          <div className="w-full h-0.5 bg-white/5">
            <motion.div
              ...
              style={{
                background: "linear-gradient(90deg, oklch(0.75 0.18 290), oklch(0.82 0.14 85))",
              }}
            ...
            <AnimatePresence mode="wait">
              {step === "intro" && (
                ...
                >
                  ...
                  <p className="text-[10px] uppercase tracking-[0.4em] text-amber-400/60 mb-3">
                  ...
                  <p className="text-sm text-white/50 leading-relaxed mb-8 max-w-sm mx-auto">
                    Não existe resposta certa ou errada. Seja sincero. Assim conseguiremos preparar
                    uma experiência que realmente faça sentido para você.
                  </p>
              ...
              {step === "result" && profile && (
                ...
                >
                  ...
                  <div
                    className="rounded-3xl p-5 mb-6 text-left"
                    style={{
                  ...
                  >
                    ...
                    <p className="text-[11px] text-white/30 mt-3">
                      Este perfil não é definitivo — ele vai crescer com você à medida que você usa
                      o app.
                    </p>
                  </div>
                  ...
                  <motion.button
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, oklch(0.58 0.2 280), oklch(0.68 0.18 260))",
                      boxShadow: "0 8px 40px oklch(0.65 0.2 280 / 0.5)",
                    }}
                  >
