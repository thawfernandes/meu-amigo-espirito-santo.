  ...
  gn: {
    1: {
      1: {
        ...
        notes:
          "O hebraico 'בְּרֵאשִׁית' (bereshit) significa literalmente 'no princípio de'. 'Elohim' é o nome plural de majestade usado para Deus neste texto, distinto de YHWH. O verbo 'bara' (criou) é usado exclusivamente com Deus como sujeito no AT, indicando criação a partir do nada (ex nihilo).",
      ...
      2: {
        ...
        notes:
          "O hebraico 'תֹהוּ וָבֹהוּ' (tohu va-vohu) indica caos, vazio e desorientação — não uma destruição, mas um estado pré-ordenado. O verbo 'merachefet' (pairava) é o mesmo usado em Dt 32:11 para a águia que paira sobre os filhotes — uma imagem de cuidado e vigilância ativa.",
        originalLang: "hebraico",
      },
      26: {
  ...
  sl: {
    23: {
      1: {
        ...
        notes:
          "A construção hebraica 'lo echsar' (לֹא אֶחְסָר) é um imperfecto na primeira pessoa — 'não terei falta' ou 'não faltarei'. A ênfase não está em prosperidade material mas na suficiência total provida pela relação pastoral com o Senhor.",
        originalLang: "hebraico",
      },
      2: {
        text: "Em pastagens de [erva] tenra ele me faz deitar; sobre águas de repouso ele me guia.",
        notes:
          "'Niot deshe' (נְאוֹת דֶּשֶׁא) — pastagens de erva tenra/verde. 'Mei menuchot' (מֵי מְנֻחוֹת) — literalmente 'águas de repouso', podendo indicar água parada (ao contrário de correnteza perigosa para ovelhas) ou lugar de descanso espiritual.",
        originalLang: "hebraico",
      },
      3: {
        text: "Minha alma [nefesh] ele restaura; ele me guia por trilhos de justiça [tzedek] por causa do seu nome.",
        notes:
          "'Nefesh' (נֶפֶשׁ) é mais amplo que 'alma' — abrange vida, ser, anseio, garganta. Restaurar a nefesh é renovar a vida inteira. 'Tzedek' (justiça/retidão) indica os caminhos corretos, alinhados com o caráter de Deus — não apenas moralidade, mas ordenamento correto da realidade.",
        originalLang: "hebraico",
      },
      4: {
        ...
        notes:
          "'Gei tzalmavet' (גֵּיא צַלְמָוֶת) — literalmente 'vale da sombra-de-morte'. Tzalmavet combina 'tzelem' (sombra) e 'mavet' (morte), criando uma imagem de obscuridade mortal. O cajado (shebet) e o bordão (mishen) eram ferramentas do pastor — o cajado para controlar o rebanho e afastar predadores, o bordão como apoio e guia.",
        originalLang: "hebraico",
      },
      5: {
        ...
        notes:
          "A imagem muda de pastoral para real — Deus como anfitrião de um banquete de honra na presença dos inimigos. A unção com óleo era gesto de honra e distinção para hóspedes especiais. A taça transbordante sugere abundância que ultrapassa a capacidade de conter.",
        originalLang: "hebraico",
      },
      6: {
        ...
        notes:
          "'Chesed' (חֶסֶד) é um dos termos mais ricos do AT, frequentemente traduzido como 'misericórdia', 'amor leal', 'fidelidade amorosa' — descreve o amor comprometido de aliança. 'L'orek yamim' significa literalmente 'por extensão de dias' — pode indicar toda a vida terrena ou também a eternidade.",
        originalLang: "hebraico",
      },
    },
    119: {
      105: {
        ...
        notes:
          "'Dabar' (דָּבָר) é 'palavra' mas também 'coisa/realidade/evento' — a palavra de Deus não é apenas discurso mas realidade acontecida. A lâmpada ilumina apenas o próximo passo, não todo o caminho — sugere dependência contínua e caminhada de confiança passo a passo.",
        originalLang: "hebraico",
      },
    },
  },
  ...
  pv: {
    3: {
      5: {
        ...
        notes:
          "'Lev' (לֵב) em hebraico é o centro da pessoa — inteligência, vontade, emoções e caráter — não apenas sentimento. 'Binah' é discernimento/compreensão racional. O chamado é abandonar a autossuficiência intelectual e confiar totalmente em YHWH como centro da existência.",
        originalLang: "hebraico",
      },
      6: {
        text: "Em todos os teus caminhos reconhece-o, e ele endireitará tuas veredas.",
        notes:
          "'Yashár' (יָשַׁר) significa 'tornar reto, direto, alinhado'. O compromisso de reconhecer (da'at — conhecimento de relação íntima) a Deus em cada aspecto da vida resulta em Deus mesmo alinhando os caminhos do crente.",
        originalLang: "hebraico",
      },
    },
  },
  ...
  is: {
    ...
    53: {
      5: {
        ...
        notes:
          "'Chalal' (חָלַל) descreve ser atravessado, profanado — uma ferida que penetra. 'Pesha' são transgressões — rebeliões deliberadas contra Deus. 'Avon' é iniquidade — desvio moral. 'Shalom' é completude, bem-estar integral. 'Chaburah' é a marca do açoite. A substituição vicária é apresentada com precisão cirúrgica no hebraico.",
        originalLang: "hebraico",
      },
    },
  },
  ...
  jo: {
    1: {
      1: {
        ...
        notes:
          "O grego 'Logos' (Λόγος) é preservado aqui pois não tem equivalente exato — abrange palavra, razão, princípio ordenador, expressão, discurso. A preposição 'pros' (πρός) indica não apenas 'com' mas 'voltado para, em direção a' — uma relação dinâmica e orientada, não estática. A construção 'kai Theos ên ho Logos' coloca 'Theos' sem artigo (predicativo) — Deus era o Logos em sua natureza, mas não no sentido de ser idêntico ao Pai.",
        originalLang: "grego",
      },
      14: {
        ...
        notes:
          "'Eskenoosen' (ἐσκήνωσεν) — literalmente 'armou sua tenda, tabernaculou'. A mesma raiz de 'shekinah' hebraico — a presença habitante de Deus. João conecta a encarnação do Logos ao tabernáculo/tenda do AT onde Deus habitava no meio de Israel. 'Monogenes' (unigênito) indica filho único, o único na sua classe, inigualável.",
        originalLang: "grego",
      },
    },
    3: {
    ...
    14: {
      6: {
        ...
        notes:
          "O grego usa o artigo definido antes de cada substantivo: 'ho hodos kai he aletheia kai he zoe' — 'o caminho... a verdade... a vida' — absolutos e exclusivos. O 'Ego eimi' (Eu sou) ecoa o nome divino revelado em Êx 3:14 (LXX: 'ego eimi ho on'). Jesus não apresenta um caminho, mas se identifica como O caminho.",
        originalLang: "grego",
      },
    },
  },
  ...
  rm: {
    8: {
      28: {
        ...
        notes:
          "'Synergei' (συνεργεῖ) — trabalham juntas, cooperam. Não que todas as coisas sejam boas, mas que Deus as faz trabalhar em conjunto para produzir bem. 'Kletois' são os chamados — não automáticos, mas aqueles que respondem ao chamado de Deus. 'Prothesis' é propósito deliberado, plano estabelecido de antemão — a soberania de Deus não é reativa mas intencional.",
        originalLang: "grego",
      },
    },
  },
  ...
  ap: {
    1: {
      8: {
        ...
        notes:
          "'Ho erchomenos' (ὁ ἐρχόμενος) — literalmente 'o vindo', participio presente — não 'que virá' mas 'que está vindo' — indicando movimento contínuo em direção à consumação. 'Pantokrator' (Παντοκράτωρ) — aquele que segura tudo, que governa todo o cosmos. Muito mais abrangente que 'Todo-Poderoso' — é soberania ativa e sustentadora.",
        originalLang: "grego",
      },
    },
  },
