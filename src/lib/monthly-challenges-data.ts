...
const ALL_CHALLENGES: MonthlyChallenge[] = [
  {
    ...
    description:
      "Dedique um momento diário para interceder especificamente por outra pessoa, fortalecendo a comunhão e o amor fraternal.",
    verseRef: "Tiago 5:16",
    verseText:
    ...
    objective:
      "Desenvolver uma vida de intercessão e lembrar que podemos carregar as necessidades de outras pessoas em oração.",
    emoji: "🙏",
    suggestions: [
  ...
  },
  {
    ...
    description:
      "Faça algo de valor para alguém de forma discreta ou anônima, exercitando a generosidade pura.",
    verseRef: "Mateus 6:3-4",
    verseText:
      "Mas, quando você der esmola, que a sua mão esquerda não saiba o que está fazendo a direita, de forma que a sua esmola fique em segredo.",
  ...
  },
  {
    ...
    description:
      "Estenda a mão para quem precisa de apoio prático, emocional ou espiritual no seu círculo social.",
  ...
  },
  {
    ...
    description:
      "Dedique tempo para honrar e apoiar alguém da terceira idade, valorizando sua sabedoria e presença.",
  ...
  },
  {
    ...
    description:
      "Apoie ações que cuidam de crianças, órfãos ou pessoas em situação de extrema vulnerabilidade social.",
    verseRef: "Tiago 1:27",
    verseText:
      "A religião que Deus, nosso Pai, aceita como pura e impecável é esta: cuidar dos órfãos e das viúvas em suas dificuldades.",
  ...
  },
  {
    ...
    description:
      "Coloque suas habilidades (profissionais, artísticas ou manuais) à disposição do Reino e do próximo.",
    verseRef: "1 Pedro 4:10",
    verseText:
      "Cada um exerça o dom que recebeu para servir os outros, administrando fielmente a multiforme graça de Deus.",
  ...
  },
  {
    ...
    description:
      "Foque exclusivamente no louvor e agradecimento, cultivando um coração contente e reconhecido.",
    verseRef: "1 Tessalonicenses 5:18",
    verseText:
      "Deem graças em todas as circunstâncias, pois esta é a vontade de Deus para vocês em Cristo Jesus.",
    objective:
      "Desenvolver um espírito de contentamento e um coração mais grato pelas bênçãos diárias.",
    emoji: "🌱",
    suggestions: [
  ...
  },
  {
    ...
    description:
      "Seja um mensageiro da Palavra de Deus, transmitindo esperança a quem precisa de consolo.",
    verseRef: "Marcos 16:15",
    verseText: "E disse-lhes: 'Vão por todo o mundo e preguem o evangelho a toda criatura'.",
    objective:
      "Incentivar a partilha da Palavra de Deus de maneira natural, respeitosa e afetuosa.",
    emoji: "📖",
    suggestions: [
