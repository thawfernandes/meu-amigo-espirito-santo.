...
export const TRANSLATIONS: Translation[] = [
  {
    id: "ORIGINAL",
    name: "Linguagem Próxima do Original",
    description: "Tradução literal dos textos originais com base em hebraico, aramaico e grego",
  },
];
...
export function getVerses(
  ...
  if (normTrans === "ORIGINAL" || normTrans === "NT") {
    generated[1] =
      "A tradução 'Linguagem Próxima do Original' para este capítulo ainda está sendo processada pela IA e logo estará disponível.";
  } else {
