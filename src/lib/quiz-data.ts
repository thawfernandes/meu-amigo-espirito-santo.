...
export const BIBLE_QUESTIONS: BibleQuestion[] = [
  // ── Gênesis 1 ──────────────────────────────────────────────────────────
  {
    ...
    explanation:
      "Gênesis 1:1 afirma textualmente: 'No princípio Deus criou os céus e a terra', estabelecendo Deus como o Criador Soberano de todo o universo antes de iniciar os detalhes da criação.",
  ...
  },
  {
    ...
    correctAnswer: "Falso",
    explanation:
      "A Bíblia diz em Gênesis 1:2 que 'a terra era sem forma e vazia' e 'trevas cobriam a face do abismo', o que significa que o estado inicial era desolado e desabitado antes da ação organizadora de Deus.",
    suggestedReading: "Gênesis 1",
  },
  {
    id: "gn-1-q3",
    ...
    explanation:
      "Deus disse: 'Haja luz', e houve luz. Deus viu que a luz era boa e fez separação entre a luz e as trevas, chamando à luz Dia e às trevas Noite (Gênesis 1:3-5).",
    suggestedReading: "Gênesis 1",
  },
  ...
  // ── Questões Gerais (Foco Adaptativo e Temático) ─────────────────────────
  {
    ...
    explanation:
      "Moisés liderou a libertação do Egito; Daniel foi poupado na cova dos leões na Pérsia; Jonas tentou fugir de ir a Nínive e foi tragado por um peixe; Noé construiu a arca para salvar sua família do dilúvio.",
  ...
  },
  {
    ...
    correctAnswer: "Josué",
    explanation:
      "Josué proferiu essas palavras no final da sua vida, ao reunir todas as tribos de Israel em Siquém, desafiando o povo a escolher a quem serviriam (Josué 24:15).",
