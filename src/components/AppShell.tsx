          ...
          <Link to="/dashboard" className="flex items-center gap-3 group">
            ...
            <span className="relative shrink-0 w-8 h-8">
              <span
                ...
                style={{
                  background: "radial-gradient(circle, oklch(0.82 0.14 85 / 0.6), transparent 70%)",
                }}
              />
              <span
                className="absolute inset-1 rounded-full"
                style={{
                  background: "radial-gradient(circle, oklch(0.72 0.18 270), oklch(0.58 0.2 290))",
                }}
              />
            </span>
          ...
          {nav.map((n) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={`mt-0.5 font-medium transition-all ${active ? "text-white" : "text-white/40"}`}
                >
                  {n.label}
                </span>
                {active && (
